...
ENDPOINT_SHEETY = "The LINK to your google sheet here." # Do not forget to authenticate with sheety with google
...
response_nutrionix_api = requests.post(ENDPOINT_EXERCISE, json=nutrionix_params, headers=nutrionix_headers)
...
for exercise in data_nutrionix:
    ...
    response_sheety_api = requests.post(ENDPOINT_SHEETY, json=sheety_params, auth=(sheety_user, sheety_pass))
