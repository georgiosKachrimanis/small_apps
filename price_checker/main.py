...
MY_PASSWORD = os.environ.get(
    "MY_SECOND_EMAIL_KEY"
)  # The smtp service providers can create an one time password to use to lod in the email API. You can find more information with some google search!
MY_SMTP_SERVER = os.environ.get(
    "MY_SMTP_SERVER"
